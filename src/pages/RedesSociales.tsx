...
const RedesSociales = () => {
  ...
  const posts: Post[] = [
    ...
    },
    {
      id: 3,
      redSocial: 'twitter',
      contenido: '¡Últimas entradas disponibles! No te pierdas el evento del año para mascotas y sus familias. 🎫🐱',
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">¿Quieres ser parte de nuestra comunidad?</h2>
              <p className="text-gray-600 text-xl">
                Sigue nuestras redes sociales para no perderte ninguna actualización del festival
              </p>
            </div>
